...
function checkConfigs(config) {
    ...
    if (process.env.secretId && process.env.secretKey) {
        cfgs.secretId = process.env.secretId
        cfgs.secretKey = process.env.secretKey
    }
    ...
    if (!cfgs.cdnUrl || !cfgs.bucket || !cfgs.region || !cfgs.secretId || !cfgs.secretKey) {
        ...
        if (!cfgs.cdnConfig) {
            ...
            if (!cfgs.cdnConfig.enable) {
                ...
                if (process.env.secretId && process.env.secretKey) {
                    cfgs.cdnConfig.secretId = process.env.secretId
                    cfgs.cdnConfig.secretKey = process.env.secretKey
                }
